...
const reg_doctor_categoryModel = require('./reg_doctor_categoryA.model');
...
Registration_doctor_arxivModel.hasMany(reg_doctor_categoryModel, {as: 'reg_doctor_category_arxiv', foreignKey: 'doctor_id'})
